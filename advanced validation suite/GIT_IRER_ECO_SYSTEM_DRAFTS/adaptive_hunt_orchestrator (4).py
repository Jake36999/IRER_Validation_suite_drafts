...
def run_simulation_job(config_hash: str, params_filepath: str) -> bool:
    ...
    try:
        ...
        subprocess.run(worker_command, check=True, capture_output=True, text=True)
        ...
        subprocess.run(validator_command, check=True, capture_output=True, text=True)
...
def main():
    ...
    for gen in range(NUM_GENERATIONS):
        ...
        for params_dict in parameter_batch:
            ...
            # [removed due to bug] params_dict['config_hash'] = config_hash Add hash to params_dict
